...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Create a path from the room to the nearest entrance using Breadth-first search\cite{missingCitation}(stairs on the lower levels count as entrances to that level).
